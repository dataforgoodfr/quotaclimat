...
def upgrade() -> None:
    ...
    # Create index on source_code for faster source_delete operations
    op.create_index(
        "ix_factiva_articles_source_code", "factiva_articles", ["source_code"]
    )

    # Create index on is_deleted for faster queries on active articles
    op.create_index(
        "ix_factiva_articles_is_deleted", "factiva_articles", ["is_deleted"]
    )

    # Create index on publication_datetime for time-based queries
    op.create_index(
