...
FROM (
	select
		...
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'id'])::TEXT AS data_item_id,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'channel'])::TEXT AS data_item_channel,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'channel_name'])::TEXT AS data_item_channel_name,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'channel_title'])::TEXT AS data_item_channel_title,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'channel_program'])::TEXT AS data_item_channel_program,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'channel_program_type'])::TEXT AS data_item_channel_program_type,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'day'])::DECIMAL AS data_item_day,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'month'])::DECIMAL AS data_item_month,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'year'])::DECIMAL AS data_item_year,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'start'])::TIMESTAMP AS data_item_start,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'model_name'])::TEXT AS data_item_model_name,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'model_reason'])::TEXT AS data_item_model_reason,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'model_result'])::DECIMAL AS data_item_model_result,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'plaintext'])::TEXT AS data_item_plaintext,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'plaintext_whisper'])::TEXT AS data_item_plaintext_whisper,
		(labelstudio_task_aggregate.data #>> ARRAY['item', 'url_mediatree'])::TEXT AS data_item_url_mediatree,
