        ...
        # Split TV / Radio
            ...
            if as_percent:
                ...
                fig = px.area(
                    ...
                    color=split,
                    groupnorm="fraction",
                    title="Evolution du nombre de mentions au cours du temps par type de média en %",
                    height=400,
                )
    ...
    # Aggregate by channel if a list of channels is provided
        ...
        if kind == "line":
            fig = px.line(
                ...
                y="count",
                color="channel_name",
                title="Evolution du nombre de mention au cours du temps par chaîne",
                height=400,
            )
...
def show_mentions_by_time_of_the_day(
    data, freq="1H", kind="bar", as_percent=False, split=None, list_of_channels=None
):
