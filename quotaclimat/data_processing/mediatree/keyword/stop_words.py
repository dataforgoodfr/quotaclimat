...
STOP_WORDS = [
    ...
    ,"byd le leader mondial du véhicule électrique"
    ,"chaque jour les changements climatiques envoyé vite vos vidéos" # rfi 
    ,"changements environnementaux et climatiques dans leurs localités participer aux formations en ligne et envoyez vos vidéos de trois minutes" # rfi 
    ,"redonner ou recycler"
    ,"cite toujours utile pour faire le tri"
    ,"crèmes abeille royale"
    ,"agit pour la protection des abeilles"
    ,"isolation photovoltaïques de pompe à chaleur pour une rénovation globale groupe verlaine"
    ,"isolation photovoltaïque et pompes à chaleur pour une rénovation"
    ,"verlaine photovoltaïque isolation pompes centrale à photovoltaïque"
    ,"on peut installer une pompe à chaleur un ballon thermodynamique ou des panneaux solaires plus respectueux de l' environnement"
    ,"des gaz renouvelables et de l' hydrogène vert et gaz nous transportons le gaz et connectons les énergies d' avenir"
    ,"des gaz renouvelables et de l' hydrogène gèrent gaz nous transportons le gaz et connectons les énergies d' avenir"
    ,"des gaz renouvelé renouvelables et de l' hydrogène"
    ,"connectons les énergies d' avenir"
    ,"senseo et produit de façon plus durable plus responsable"
    ,"durable plus responsable senseo"
    ,"surtout reconditionné pour être plus durable"
    ,"conseils adaptés à votre alimentation"
    ,"qui vous font économiser du carburant"
    ,"recharge nissan"
    ,"recharge ionity"
    ,"je suis super agiles et je me recharge rapidement"
    ,"qui se recharge pendant que vous vous"
    ,"électrique pour être plus responsable mais surtout reconditionné"
    ,"électriques pour être plus responsable mais surtout reconditionné"
    ,"entreprises engagées responsable sur le territoire caisse"
    ,"assurance vie responsable"
    ,"avec habitat et jardin"
    ,"spécialiste de la maison du jardin"
    ,"mobilier de jardin"
    ,"les moustiques profiter du jardin"
    ,"jardin gardena"
    ,"nous dépendons tous ce réseau c' est la biodiversité" #gouv
    ,"les valeurs plus écoresponsable au sein de la caisse d"
    ,"c' est pas du recyclage en faire du reconditionnement"
    ,"meilleures astuces antigaspillage"
    ,"mur végétalisé les tuiles se transforment en panneaux solaires"
    ,"vous aide à améliorer la performance énergétique"
    ,"quotidien prenez les transports en commun"
    ,"ce moment au pouvoir acheter une voiture électrique peut être"
    ,"pouvoir acheter une voiture électrique ça pouvait être une prise"
    ,"connaître la valeur de votre voiture simplement et rapidement"
    ,"la citroën c4 you c' est une voiture très familial"
    ...
    ,"étiez nombreux à l' attendre la voiture électrique accessible à tous"
    ,"ournisseur officiel d' électricité renouvelable de paris"
    ,"garanties d' origine renouvelable promotion valable sur l' abonne"
    ,"électricité de gaz cent pour cent renouvelable songez simplement"
    ,"bien se chauffer au bois point ademe point fr"
