...
from data_analytics.data_coverage import fig_percentage_of_covered_time_by_keywords
PATH_EXTRACTS_DATA_DUMPS = "data/keywords/"
PATH_CHANNEL_METADATA = "data/channels.xlsx"


def run():
    df_all = read_and_format_all_data_dump(PATH_EXTRACTS_DATA_DUMPS, PATH_CHANNEL_METADATA)
    # figures answering the questions
    fig_percentage_of_covered_time_by_keywords_ = fig_percentage_of_covered_time_by_keywords(df_all)
    # streamlit interface
