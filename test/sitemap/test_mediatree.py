...
def test_get_channels():
    if(os.environ.get("ENV") == "docker"):
        ...
        assert get_channels() == ["tf1", "france2", "fr3idf", "france5", "m6", "arte", "d8", "tmc", "bfmtv", "lci", "franceinfotv", "itele",
        "europe1", "franceculture", "franceinter", "sudradio", "rmc", "rtl", "france24", "franceinfo", "rfi"]
